...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<Entities.Entities.ApplicationUser>(options => options.SignIn.RequireConfirmedAccount = false)
            ...
            services.AddSingleton<IApplicationNews, ApplicationNews>();
